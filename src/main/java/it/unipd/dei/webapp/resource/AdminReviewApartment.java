...
public class AdminReviewApartment {
    ...
    public AdminReviewApartment (final String address, final int n_room, final int n_bath,
                                 final String s_kitchen, final Integer p_code, final String energy_class,
                         final Double totSquareMeter, final String status, final String extra_info ) {
