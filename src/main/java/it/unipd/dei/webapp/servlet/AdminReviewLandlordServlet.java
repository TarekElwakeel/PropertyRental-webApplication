...
import it.unipd.dei.webapp.database.AdminReviewLandlorddatabase;
...
public final class AdminReviewLandlordServlet extends AbstractDatabaseServlet {
    /**
     *
     * @param req
     * @param res
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        // model
        List<AdminReviewLandlord> el = null;
        Message m = null;
        ...
        try {
            ...
            el = new AdminReviewLandlorddatabase(getDataSource().getConnection(), status)
                    .Viewlandlordad();
        ...
        req.setAttribute("AdminReviewLandlordList", el);
        req.setAttribute("message", m);

        // forwards the control to the result JSP
        req.getRequestDispatcher("/jsp/AdminReviewLandlord-Result.jsp").forward(req, res);
