...
import it.unipd.dei.webapp.database.AdminUpdateStudentdatabase;
...
public final class AdminUpdateStudentServlet extends AbstractDatabaseServlet {
    /**
     *
     * @param req
     * @param res
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            new AdminUpdateStudentdatabase(getDataSource().getConnection(), status, s_taxcode).AdminUpdateStudent();

            m = new Message(String.format("Student with FC %s successfully updated.", s_taxcode));
        ...
        req.getRequestDispatcher("/jsp/AdminUpdateStudent-Result.jsp").forward(req, res);
