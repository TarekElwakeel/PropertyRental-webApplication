...
<div class="form row d-inline float-right">
    <select class="form-group column-4" name="status" id="sudstatus">
        <option selected>Choose...</option>
        <option value="new">new</option>
        <option value="verified">verified</option>
        <option value="pending">pending</option>
    </select>
    <input class="form-group column-4 btn-primary active" type="button" value="Search" name="studentstatusServlet" id="callstustatus"/>
</div>
<div id="studstatus"></div>
