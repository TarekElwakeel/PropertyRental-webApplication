...
<h3>Please enter Student taxcode and the status to be changed too </h3>

<form class="form" method="POST" action="<c:url value="/Admin-UpdateStudent"/>">

    <label for="status">status:</label>
    <input name="status" type="text"/><br/><br/>

    <label for="s_taxcode">s_taxcode:</label>
